...
public:
    ...
    void Print(int iteration)
    {
        ...
        {
            std::cout << "Worker[" << i << "] -> Task[" << _workers[i] << "]" << std::endl;
        }
        std::cout << std::endl;
    }
...
public:
    ...
    // функция оценки
    void Evaluate(CostMatrix &costMatrix, int iteration) 
    {
